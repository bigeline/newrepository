...
public class ShipWeeklyPlanQuery {
    ...
    private String getEdiVoyageInfoURL;
    private String vesselname;
    private String voyage;

    public ShipWeeklyPlanQuery(HttpClient httpClient, String getEdiVoyageInfoURL, String vesselname, String voyage) {
        this.httpClient = httpClient;
        this.getEdiVoyageInfoURL = getEdiVoyageInfoURL;
